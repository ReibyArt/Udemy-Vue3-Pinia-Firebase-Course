<template>
    ...
    <Form class="mb-5" @submit="onSubmit" :validation-schema="ArticleSchema">
            <div class="mb-4">
                <!-- Name of the game -->
                <Field 
                    name="game" v-slot="{field, errors, errorMessage}">
                    <input 
                        type="text"
                        class="form-control"
            ...
            <!-- Title of the article -->
             <div class="mb-4">
                <Field 
                    name="title" v-slot="{field, errors, errorMessage}">
                    <input 
                        type="text"
                        class="form-control"
            ...
            <div class="mb-4">
                <Field 
                    name="excerpt" v-slot="{field, errors, errorMessage}">
                    <textarea 
                        rows="3"
                        class="form-control"
            ...
            <div class="mb-4">
                <Field 
                    name="rating" value="Select of a rating" v-slot="{field, errors, errorMessage}">
            ...
            <div class="mb-4">
                <!-- Name of the game -->
                <Field 
                    name="image" v-slot="{field, errors, errorMessage}">
                    <input 
                        type="text"
                        class="form-control"
